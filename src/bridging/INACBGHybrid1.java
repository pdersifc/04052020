 ...
 * @author perpustakaan
 */
public class INACBGHybrid1 extends javax.swing.JDialog {
    ...
    public INACBGHybrid1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initComponents2();
            ...
            public void run() {
                ...
                engine.titleProperty().addListener((ObservableValue<? extends String> observable, String oldValue, final String newValue) -> {
                    SwingUtilities.invokeLater(() -> {
                        INACBGHybrid1.this.setTitle(newValue);
                    });
                });
                ...
                engine.getLoadWorker().stateProperty().addListener(new ChangeListener<State>() {
                    ...
                    public void changed(ObservableValue ov, State oldState, State newState) {
                        if (newState == State.SUCCEEDED) {
                            try {
                                if(engine.getLocation().replaceAll("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/","").contains("inacbg_corona/pages")){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            INACBGHybrid1 dialog = new INACBGHybrid1(new javax.swing.JFrame(), true);

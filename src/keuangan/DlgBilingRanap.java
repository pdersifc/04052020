...
public class DlgBilingRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-07-2020 09:47:27" }));
            ...
            try {
                ...
                if(i==0){ 
                    ...
                    try {
                        ...
                        if(rsservice.next()){
                            biayaMin = Double.parseDouble(rsservice.getString("biaya_minimal"));
                            biayaMax = Double.parseDouble(rsservice.getString("biaya_maximal"));

...
import fungsi.akses;
import inventory.DlgCariObatNonFornas;
...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnFormulirPenerimaan2 = new javax.swing.JMenuItem();
        ...
        MnSimulasiBilling = new javax.swing.JMenuItem();
        ...
        MnFormulirPenerimaan2.setBackground(new java.awt.Color(51, 204, 0));
        MnFormulirPenerimaan2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnFormulirPenerimaan2.setForeground(new java.awt.Color(50, 50, 50));
        MnFormulirPenerimaan2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnFormulirPenerimaan2.setText("Cetak CM1");
        MnFormulirPenerimaan2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnFormulirPenerimaan2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnFormulirPenerimaan2.setName("MnFormulirPenerimaan2"); // NOI18N
        MnFormulirPenerimaan2.setPreferredSize(new java.awt.Dimension(210, 26));
        MnFormulirPenerimaan2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnFormulirPenerimaan2ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnFormulirPenerimaan2);

        MnSKDPBPJS1.setBackground(new java.awt.Color(255, 153, 255));
        ...
        MnSKDPBPJS1.setText("Buat Surat Kontrol");
        ...
        MnObatNonfornasBpjs.setBackground(new java.awt.Color(255, 153, 204));
        MnObatNonfornasBpjs.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnObatNonfornasBpjs.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnObatNonfornasBpjs.setText("Input Obat Rekonsiliasi");
        MnObatNonfornasBpjs.setName("MnObatNonfornasBpjs"); // NOI18N
        MnObatNonfornasBpjs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnObatNonfornasBpjsActionPerformed(evt);
            }
        });
        MnObat.add(MnObatNonfornasBpjs);
        ...
        MnSimulasiBilling.setBackground(new java.awt.Color(255, 255, 255));
        MnSimulasiBilling.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSimulasiBilling.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSimulasiBilling.setText("Simulasi Billing");
        MnSimulasiBilling.setName("MnSimulasiBilling"); // NOI18N
        MnSimulasiBilling.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSimulasiBillingActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnSimulasiBilling);
                        ...
                        if (tabMode.getRowCount() == 0) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if (rs2.next()) {
                                        noRm = rs2.getString("no_rkm_medis");
                                        ...
                                        if (Sequel.cariRegistrasi(tbKamIn.getValueAt(tbKamIn.getSelectedRow() - 1, 0).toString()) > 0) {
                                            ...
                                            panggilobat(rs2.getString("no_rawat2"), noRm, nmPasien);
                                        }
                                    } else {
                            ...
                            if (Sequel.cariRegistrasi(norawat.getText()) > 0) {
                                ...
                                panggilobat(norawat.getText(), noRm, nmPasien);
...
private void MnRujukMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukMasukActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbKamIn.getSelectedRow() > -1) {
                if (tbKamIn.getValueAt(tbKamIn.getSelectedRow(), 0).toString().equals("")) {
                        ...
                        try {
                            ...
                            if (rs2.next()) {
                                ...
                                Valid.MyReportqry("rptBarcodeRawat.jasper", "report", "::[ Barcode No.Rawat ]::",
                                        "SELECT reg_periksa.no_rawat,pasien.nm_pasien,reg_periksa.no_rkm_medis,pasien.tgl_lahir,pasien.no_ktp FROM reg_periksa INNER JOIN pasien ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis WHERE reg_periksa.no_rawat='" + rs2.getString("no_rawat2") + "'", param);
                                this.setCursor(Cursor.getDefaultCursor());
                            } else {
                                JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu pasien...!!!");
                                tbKamIn.requestFocus();
                    ...
                    param.put("emailrs", akses.getemailrs());
                    Valid.MyReportqry("rptBarcodeRawat.jasper", "report", "::[ Barcode No.Rawat ]::",
                            "SELECT reg_periksa.no_rawat,pasien.nm_pasien,reg_periksa.no_rkm_medis,pasien.tgl_lahir,pasien.no_ktp FROM reg_periksa INNER JOIN pasien ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis WHERE reg_periksa.no_rawat='" + norawat.getText() + "'", param);
                    this.setCursor(Cursor.getDefaultCursor());
                }
            }
        }
    ...
    private void MnFormulirPenerimaan2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnFormulirPenerimaan2ActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        } else if (tbKamIn.getValueAt(tbKamIn.getSelectedRow(), 0).toString().equals("")) {
    ...
    }//GEN-LAST:event_MnFormulirPenerimaan2ActionPerformed
    ...
    private void MnObatNonfornasBpjsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnObatNonfornasBpjsActionPerformed
        // TODO add your handling code here:
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
            ...
            if (tbKamIn.getValueAt(tbKamIn.getSelectedRow(), 0).toString().equals("")) {
                ...
                if (Sequel.cariRegistrasi(norawat.getText()) > 0) {
                    ...
                    DlgCariObatNonFornas obatNonFornas = new DlgCariObatNonFornas(null, false);
                    obatNonFornas.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
                    obatNonFornas.setLocationRelativeTo(internalFrame1);
                    obatNonFornas.emptTeks();
                    obatNonFornas.isCek();
                    obatNonFornas.setNoRm(norawat.getText(), DTPCari1.getDate(), noRm, nmPasien);
                    obatNonFornas.tampil();
                    obatNonFornas.setVisible(true);
    ...
    }//GEN-LAST:event_MnObatNonfornasBpjsActionPerformed

    private void MnSimulasiBillingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSimulasiBillingActionPerformed
        // TODO add your handling code here:
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (row > 0) {
                String norwt = tbKamIn.getValueAt(row, 0).toString();
                DlgSimulasiBilling simbilling = new DlgSimulasiBilling(null, false, norwt);
                simbilling.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
                simbilling.setLocationRelativeTo(internalFrame1);
                simbilling.setVisible(true);
            }else{
               JOptionPane.showMessageDialog(null, "Untuk melakukan Simulasi Billing, Silahkan pilih pasien pada table"); 
            }
    ...
    private javax.swing.JMenuItem MnObatNonfornasBpjs;
    ...
    private javax.swing.JMenuItem MnSimulasiBilling;
    ...
    private void getData() {
        ...
        if (tbKamIn.getSelectedRow() != -1) {
            ...
            noRm = tbKamIn.getValueAt(tbKamIn.getSelectedRow(), 1).toString();
            nmPasien = tbKamIn.getValueAt(tbKamIn.getSelectedRow(), 2).toString();
        }
    }
    ...
    private void panggilobat(String norawat, String noRkmMedis, String nmPasien) {
        if (Sequel.cariInteger("select count(no_rawat) from stok_obat_pasien where no_rawat=? ", norawat) > 0) {
            ...
            billing.beriobat.dlgobt.setNoRm(norawat, date, noRkmMedis, nmPasien);

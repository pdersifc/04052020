...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnSKDPBPJS3 = new javax.swing.JMenuItem();
        ...
        MnSKDPBPJS3.setBackground(new java.awt.Color(255, 51, 255));
        MnSKDPBPJS3.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSKDPBPJS3.setForeground(new java.awt.Color(50, 50, 50));
        MnSKDPBPJS3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSKDPBPJS3.setText("Buat Surat Kontrol");
        MnSKDPBPJS3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnSKDPBPJS3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnSKDPBPJS3.setName("MnSKDPBPJS3"); // NOI18N
        MnSKDPBPJS3.setPreferredSize(new java.awt.Dimension(170, 26));
        MnSKDPBPJS3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSKDPBPJS3ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnSKDPBPJS3);
        ...
        MnCetakSuratSehat2.setText("Surat Keterangan Sehat");
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-06-2020" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-06-2020" }));
        ...
        DlgSakit3.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        DlgSakit3.setName("DlgSakit3"); // NOI18N
        DlgSakit3.setUndecorated(true);
        DlgSakit3.setResizable(false);

        internalFrame9.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "::[ Cetak Surat Keterangan Kesehatan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 50))); // NOI18N
        ...
        panelBiasa5.add(BtnPrint6);
        BtnPrint6.setBounds(50, 50, 100, 30);
        ...
        BtnKeluar5.setBounds(400, 50, 100, 30);

        NomorSuratSehat.setText("/RSIFC/SKD/XI/20");
        NomorSuratSehat.setHighlighter(null);
        NomorSuratSehat.setName("NomorSuratSehat"); // NOI18N
        NomorSuratSehat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NomorSuratSehatActionPerformed(evt);
            }
        });
        panelBiasa5.add(NomorSuratSehat);
        NomorSuratSehat.setBounds(150, 10, 370, 23);

        internalFrame9.add(panelBiasa5, java.awt.BorderLayout.CENTER);

        DlgSakit3.getContentPane().add(internalFrame9, java.awt.BorderLayout.CENTER);

        DlgSakit4.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        DlgSakit4.setName("DlgSakit4"); // NOI18N
        DlgSakit4.setUndecorated(true);
        DlgSakit4.setResizable(false);

        internalFrame11.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "::[ Cetak Surat Keterangan Kesehatan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 50))); // NOI18N
        ...
        jLabel40.setText("Nomor Surat Keterangan :");
        jLabel40.setName("jLabel40"); // NOI18N
        panelBiasa7.add(jLabel40);
        jLabel40.setBounds(7, 10, 140, 23);

        BtnPrint8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/b_print.png"))); // NOI18N
        BtnPrint8.setMnemonic('T');
        BtnPrint8.setText("Cetak");
        BtnPrint8.setToolTipText("Alt+T");
        BtnPrint8.setName("BtnPrint8"); // NOI18N
        BtnPrint8.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnPrint8.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPrint8ActionPerformed(evt);
            }
        });
        panelBiasa7.add(BtnPrint8);
        BtnPrint8.setBounds(50, 50, 100, 30);
        ...
        panelBiasa7.add(BtnKeluar7);
        BtnKeluar7.setBounds(400, 50, 100, 30);

        NomorSuratSehat2.setText("    /RSIFC/SKD/XI/20");
        NomorSuratSehat2.setHighlighter(null);
        NomorSuratSehat2.setName("NomorSuratSehat2"); // NOI18N
        NomorSuratSehat2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NomorSuratSehat2ActionPerformed(evt);
            }
        });
        panelBiasa7.add(NomorSuratSehat2);
        NomorSuratSehat2.setBounds(150, 10, 370, 23);

        internalFrame11.add(panelBiasa7, java.awt.BorderLayout.CENTER);

        DlgSakit4.getContentPane().add(internalFrame11, java.awt.BorderLayout.CENTER);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-06-2020" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-06-2020" }));
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void ppBerkasDigital1BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBerkasDigital1BtnPrintActionPerformed
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                ...
                berkas.setJudul("::[ Berkas Digital Perawatan ]::","berkasrawat/pages");
                try {
                    berkas.loadURL("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+prop.getProperty("PORTWEB")+"/"+prop.getProperty("HYBRIDWEB")+"/"+"berkasrawat/login2.php?act=login&usere=admin&passwordte=akusayangsamakamu&no_rawat="+tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),10).toString());
                } catch (Exception ex) {
                    System.out.println("Notifikasi : "+ex);
                }
    ...
    private void MnCetakSuratSehatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSehatActionPerformed
        ...
        DlgSakit4.setSize(550,151);
        DlgSakit4.setLocationRelativeTo(internalFrame1);
        DlgSakit4.setVisible(true);
    ...
    private void MnCetakBebasNarkobaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakBebasNarkobaActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            Valid.MyReportqry("rptBebasNarkoba.jasper","report","::[ Surat Keterangan Bebas Narkoba ]::",
                ...
                " dokter.no_ijn_praktek from reg_periksa inner join pasien inner join dokter "+
    ...
    private void MnSKDPBPJS3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSKDPBPJS3ActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TPasien.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_MnSKDPBPJS3ActionPerformed
    ...
    private void BtnPrint6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint6ActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            param.put("nomersuratsehat",NomorSuratSehat.getText());
    ...
    private void NomorSuratSehatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NomorSuratSehatActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NomorSuratSehatActionPerformed
    ...
    private void BtnPrint8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint8ActionPerformed
         if(TPasien.getText().trim().equals("")){
            ...
            param.put("emailrs",akses.getemailrs());
            param.put("logo",Sequel.cariGambar("select logo from setting"));
            param.put("nomersuratsehat2",NomorSuratSehat2.getText());
    ...
    private void BtnKeluar7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluar7ActionPerformed
        DlgSakit4.dispose();    // TODO add your handling code here:
    }//GEN-LAST:event_BtnKeluar7ActionPerformed

    private void NomorSuratSehat2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NomorSuratSehat2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NomorSuratSehat2ActionPerformed
    ...
    private void MnCetakSuratSehat2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSehat2ActionPerformed
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                SuratSehat resume=new SuratSehat(null,false);
                resume.isCek();
                resume.emptTeks();
                resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                resume.setLocationRelativeTo(internalFrame1);
    ...
    */
    ...
    private javax.swing.JDialog DlgSakit3;
    private javax.swing.JDialog DlgSakit4;
    ...
    private javax.swing.JMenuItem MnSKDPBPJS3;
    ...
    private widget.TextBox NomorSuratSehat;
    private widget.TextBox NomorSuratSehat2;
    ...
    private void tampilkasir2() {                   
        ...
        try{   
            semua=caripenjab.equals("")&&CrPoli.getText().trim().equals("")&&CrPtg.getText().trim().equals("")&&cmbStatus.getSelectedItem().toString().equals("Semua")&&TCari.getText().trim().equals("");
            pskasir=koneksi.prepareStatement("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                ...
                (semua?"":"and reg_periksa.kd_pj like ? and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and "+

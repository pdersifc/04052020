...
public class BiayaRalanDokter {
    ...
    private double tindakanDOkter;
    private double bhp;
    private double material;
    private double total;
    
    public BiayaRalanDokter(){}
    ...
    /**
     * @return the tindakanDOkter
     */
    public double getTindakanDOkter() {
        return tindakanDOkter;
    }

    /**
     * @param tindakanDOkter the tindakanDOkter to set
     */
    public void setTindakanDOkter(double tindakanDOkter) {
        this.tindakanDOkter = tindakanDOkter;
    }

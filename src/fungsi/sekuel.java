...
//            }
    ...
    public Integer cariInteger88(String sql, String data, String data2, String data3, String data4, String data5) {
        angka = 0;
        try {
            ps = connect.prepareStatement(sql);
            try {
    ...
    public java.sql.Date cariTanggal(String sql, String data) {

...
public class DlgPemberianObat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-06-2020" }));
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-06-2020" }));
        ...
        btnObat1.setBounds(540, 70, 35, 25);
    ...
    */
    ...
    private void panggilform() {
        if(status.equals("ranap")){
            dlgobt.setPasien(TNoRw.getText(),TNoRM.getText(),TPasien.getText());

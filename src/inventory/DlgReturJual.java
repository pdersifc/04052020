...
public class DlgReturJual extends javax.swing.JDialog {
    ...
    private double ttlretur=0,totalPengurang=0;
    ...
    public DlgReturJual(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Nota","Kode Barang","Nama Barang","Satuan","Hrg.Retur(Rp)","Pengurang (%)","Jml.Retur","Total Retur(Rp)","No.Batch","No.Faktur"
            });
        ...
        txtPengurang.setText(String.valueOf(getReturPersentase()));
    }
    ...
    private void initComponents() {
        ...
        txtPengurang = new widget.TextBox();
        ...
        label25.setBounds(690, 40, 70, 23);
        ...
        label28.setText("Pengurang(%) :");
        label28.setName("label28"); // NOI18N
        label28.setPreferredSize(new java.awt.Dimension(90, 23));
        panelisi4.add(label28);
        label28.setBounds(550, 40, 80, 23);

        txtPengurang.setName("txtPengurang"); // NOI18N
        txtPengurang.setPreferredSize(new java.awt.Dimension(80, 23));
        txtPengurang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtPengurangKeyPressed(evt);
            }
        });
        panelisi4.add(txtPengurang);
        txtPengurang.setBounds(640, 40, 50, 23);
...
private void BtnGudangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGudangActionPerformed
    ...
    private void txtPengurangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPengurangKeyPressed
    ...
    */
    ...
    private widget.TextBox txtPengurang;
    // End of variables declaration//GEN-END:variables

    private double getReturPersentase(){
        double persen =0;
        try {
            PreparedStatement pr = koneksi.prepareStatement("select * from set_retur_jual ");
            ResultSet result = pr.executeQuery();
            while(result.next()){
                persen = result.getDouble("persentase");
                break;
            }
        } catch (SQLException ex) {
            Logger.getLogger(DlgReturJual.class.getName()).log(Level.SEVERE, null, ex);
        }
        return persen;
    }
    private void tampil() {
        Valid.tabelKosong(tabMode);
        double persen = getReturPersentase();
         try{
             ...
             try {
                ...
                while(rs.next()){
                    ...
                    totalPengurang=ttlretur*getReturPersentase()/100;
                    tabMode.addRow(new Object[]{
                        rs.getString(1),rs.getString(2),rs.getString(3),
                        rs.getString(4),rs.getDouble(7),getReturPersentase(),

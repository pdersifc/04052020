...
public class DlgRekapObatPasienDua extends javax.swing.JDialog {
    ...
    private DlgCariDokter cariDokter = new DlgCariDokter(null, false);
    private DlgCariPenyakit cariDiagnosa = new DlgCariPenyakit(null, false);
    private int i = 0, a = 0;
     ...
     * @param modal
     */
    public DlgRekapObatPasienDua(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null, new Object[]{"No.", "Tanggal", "No.RM", "Nama Pasien", "DPJP", "Diagnosa", "Nama Obat", "Jml"}) {
            @Override
        ...
        tabMode2 = new DefaultTableModel(null, new Object[]{"No.", "Tanggal", "No.RM", "Nama Pasien", "DPJP", "Diagnosa", "Nama Obat", "Jml"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
            }
        ...
        cariDokter.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
            }
            ...
            public void windowClosed(WindowEvent e) {
                if (cariDokter.getTable().getSelectedRow() != -1) {
                    kodeDokter.setText(cariDokter.getTable().getValueAt(cariDokter.getTable().getSelectedRow(), 0).toString());
                    txtDpjp.setText(cariDokter.getTable().getValueAt(cariDokter.getTable().getSelectedRow(), 1).toString());
                }
            }
        ...
        cariDiagnosa.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
            }
            ...
            public void windowClosed(WindowEvent e) {
                if (cariDiagnosa.getTable().getSelectedRow() != -1) {
                    kdPenyakit.setText(cariDiagnosa.getTable().getValueAt(cariDiagnosa.getTable().getSelectedRow(), 0).toString());
                    txtDiagnosa.setText(cariDiagnosa.getTable().getValueAt(cariDiagnosa.getTable().getSelectedRow(), 1).toString());
                }
            }
    ...
    private void initComponents() {
        ...
        grupJenisOperasi = new javax.swing.ButtonGroup();
        ...
        txtDpjp = new widget.TextBox();
        BtnDokter = new widget.Button();
        label26 = new widget.Label();
        txtDiagnosa = new widget.TextBox();
        ...
        kdPenyakit.setPreferredSize(new java.awt.Dimension(75, 23));

        kodeDokter.setEditable(false);
        kodeDokter.setName("kodeDokter"); // NOI18N
        kodeDokter.setPreferredSize(new java.awt.Dimension(75, 23));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 106));
        ...
        label24.setText("Jns Operasi :");
        label24.setName("label24"); // NOI18N
        label24.setPreferredSize(new java.awt.Dimension(40, 23));
        FormInput.add(label24);
        label24.setBounds(10, 70, 70, 23);

        label25.setText("Dokter :");
        label25.setName("label25"); // NOI18N
        label25.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label25);
        label25.setBounds(255, 70, 50, 23);

        txtDpjp.setEditable(false);
        txtDpjp.setName("txtDpjp"); // NOI18N
        txtDpjp.setPreferredSize(new java.awt.Dimension(205, 23));
        FormInput.add(txtDpjp);
        txtDpjp.setBounds(310, 70, 150, 23);
        ...
        label26.setText("Diagnosa :");
        label26.setName("label26"); // NOI18N
        label26.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label26);
        label26.setBounds(500, 70, 60, 23);

        txtDiagnosa.setEditable(false);
        txtDiagnosa.setName("txtDiagnosa"); // NOI18N
        txtDiagnosa.setPreferredSize(new java.awt.Dimension(205, 23));
        FormInput.add(txtDiagnosa);
        txtDiagnosa.setBounds(560, 70, 150, 23);
        ...
        BtnDiagnosa.setBounds(710, 70, 28, 23);
        ...
        grupJenisOperasi.add(jRadioButton1);
        jRadioButton1.setText("Bedah");
        jRadioButton1.setName("jRadioButton1"); // NOI18N
        FormInput.add(jRadioButton1);
        jRadioButton1.setBounds(90, 70, 70, 23);

        jRadioButton2.setBackground(new java.awt.Color(255, 255, 255));
        grupJenisOperasi.add(jRadioButton2);
        jRadioButton2.setSelected(true);
        jRadioButton2.setText("Non Bedah");
        jRadioButton2.setName("jRadioButton2"); // NOI18N
        FormInput.add(jRadioButton2);
        jRadioButton2.setBounds(170, 70, 90, 23);
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokterActionPerformed
        // TODO add your handling code here:        
        cariDokter.isCek();
        cariDokter.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        cariDokter.setLocationRelativeTo(internalFrame1);
        cariDokter.setAlwaysOnTop(false);
    ...
    private void BtnDiagnosaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDiagnosaActionPerformed
        // TODO add your handling code here:
        cariDiagnosa.isCek();
        cariDiagnosa.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        cariDiagnosa.setLocationRelativeTo(internalFrame1);
        cariDiagnosa.setAlwaysOnTop(false);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRekapObatPasienDua dialog = new DlgRekapObatPasienDua(new javax.swing.JFrame(), true);
    ...
    private javax.swing.ButtonGroup grupJenisOperasi;
    ...
    private widget.TextBox txtDiagnosa;
    private widget.TextBox txtDpjp;
    ...
    private void prosesCari() {
        try {
            ...
            try {
                ...
                while (rsreg.next()) {
                    if ((status.getSelectedIndex() == 0) && nmjns.getText().equals("") && nmkategori.getText().equals("") && nmgolongan.getText().equals("") && nmasal.getText().equals("") && txtDpjp.getText().equals("") && txtDiagnosa.getText().equals("")) {
                        psobat = koneksi.prepareStatement(
                                "select detail_pemberian_obat.kode_brng,databarang.nama_brng,dokter.`nm_dokter`,penyakit.`nm_penyakit`,sum(detail_pemberian_obat.jml) as jml "
                        ...
                        psobat = koneksi.prepareStatement(
                                ...
                                + "and concat(diagnosa_pasien.kd_penyakit,penyakit.nm_penyakit) like ? and concat(reg_periksa.kd_dokter,dokter.nm_dokter) like ? "
                                + "group by detail_pemberian_obat.kode_brng order by databarang.nama_brng");
                    }
                    try {
                        if ((status.getSelectedIndex() == 0) && nmjns.getText().equals("") && nmkategori.getText().equals("") && nmgolongan.getText().equals("") && nmasal.getText().equals("") && txtDpjp.getText().equals("") && txtDiagnosa.getText().equals("")) {
                            ...
                            psobat.setString(7, "%" + kdPenyakit.getText() + txtDiagnosa.getText() + "%");
                            psobat.setString(8, "%" + kodeDokter.getText() + txtDpjp.getText() + "%");
                        }
                            ...
                            while (rsobat.next()) {
                                if (a == 1) {
                                    tabMode.addRow(new String[]{
                                        ...
                                        rsobat.getString(3), rsobat.getString(4), rsobat.getString(1) + " " + rsobat.getString(2), rsobat.getString(5)

                                    });
                                    i++;
                                } else {
                                    tabMode.addRow(new String[]{
                                        "", "", "", "", "", "", rsobat.getString(1) + " " + rsobat.getString(2), rsobat.getString(5)
                                    });
                                }
                                a++;
                            }

 ...
 * @author salimmulyana
 */
public final class SuratSehat extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratSehat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat Sehat","No.Rawat","No.R.M.","Nama Pasien","Tanggal Surat","Buta Warna","Visus","Keterangan Surat"
        }){
        ...
        butawarna.setDocument(new batasInput((byte)50).getKata(butawarna));
        visus.setDocument(new batasInput((byte)50).getKata(visus)); 
    ...
    private void initComponents() {
        ...
        keterangansurat = new widget.TextBox();
        butawarna = new widget.TextBox();
        ...
        jLabel20.setText("Keterangan Surat :");
        jLabel20.setName("jLabel20"); // NOI18N

        jLabel23.setText("Buta Warna :");
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(150, 165));
        ...
        NoSurat.setBounds(110, 40, 260, 23);
        ...
        visus.setHighlighter(null);
        visus.setName("visus"); // NOI18N
        visus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                visusActionPerformed(evt);
            }
        });
        ...
        FormInput.add(visus);
        visus.setBounds(340, 100, 106, 23);

        jLabel18.setText("Visus :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(220, 100, 110, 23);

        tanggalsurat.setForeground(new java.awt.Color(50, 70, 50));
        tanggalsurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-06-2020" }));
        ...
        tanggalsurat.setBounds(530, 50, 90, 23);

        jLabel13.setText("Tanggal Surat:");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(440, 50, 80, 23);

        keterangansurat.setHighlighter(null);
        keterangansurat.setName("keterangansurat"); // NOI18N
        keterangansurat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                keterangansuratActionPerformed(evt);
            }
        });
        keterangansurat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                keterangansuratKeyPressed(evt);
            }
        });
        FormInput.add(keterangansurat);
        keterangansurat.setBounds(110, 70, 260, 23);

        butawarna.setHighlighter(null);
        butawarna.setName("butawarna"); // NOI18N
        butawarna.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                butawarnaActionPerformed(evt);
            }
        });
        butawarna.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                butawarnaKeyPressed(evt);
            }
        });
        FormInput.add(butawarna);
        butawarna.setBounds(110, 100, 180, 23);

        jLabel22.setText("Keterangan Surat :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(0, 70, 100, 23);

        jLabel24.setText("Buta Warna :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(-10, 100, 110, 23);
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Data Surat Keterangan Sehat ]::");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            Valid.textKosong(NoSurat,"No.Surat Sehat");
        }else if(visus.getText().trim().equals("")){
            Valid.textKosong(visus,"Visus");
        }else if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"pasien");
        }else if(butawarna.getText().trim().equals("")){
            Valid.textKosong(butawarna,"Buta Warna");
        }else{
            if(Sequel.menyimpantf("suratsehat","?,?,?,?,?,?","No.Surat Sehat",6,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(tanggalsurat.getSelectedItem()+""),butawarna.getText(),visus.getText(),keterangansurat.getText()
                })==true){
                tampil();
                emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,NoSurat,"suratsehat","no_surat");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("suratsehat","no_surat=?","no_surat=?,no_rawat=?,tgl_surat=?,butawarna=?,visus=?,keterangan=?",7,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(tanggalsurat.getSelectedItem()+""),butawarna.getText(),visus.getText(),keterangansurat.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                })==true){
                    tampil();
                    emptTeks();
                }
    ...
    private void visusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_visusActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_visusActionPerformed
       ...
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                Valid.MyReportqry("rptSuratSakit5.jasper","report","::[ Surat Sakit ]::",
                              "select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y')as tgl_registrasi,perusahaan_pasien.nama_perusahaan,dokter.no_ijn_praktek,reg_periksa.no_rawat,dokter.nm_dokter,pasien.keluarga,pasien.namakeluarga,pasien.tgl_lahir,pasien.jk," +
    ...
    private void keterangansuratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keterangansuratActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_keterangansuratActionPerformed

    private void keterangansuratKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_keterangansuratKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_keterangansuratKeyPressed

    private void butawarnaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_butawarnaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_butawarnaKeyPressed

    private void butawarnaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butawarnaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_butawarnaActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratSehat dialog = new SuratSehat(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox butawarna;
    ...
    private widget.TextBox keterangansurat;
    ...
    public void tampil() {
        ...
        try{
            tgl=" suratsehat.tgl_surat between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select suratsehat.no_surat,suratsehat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "suratsehat.tgl_surat,suratsehat.butawarna,suratsehat.visus,suratsehat.keterangan "+                  
                     "from suratsehat inner join reg_periksa on suratsehat.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "where "+tgl+" order by suratsehat.no_surat");
            }else{
                ps=koneksi.prepareStatement(
                     "select suratsehat.no_surat,suratsehat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "suratsehat.tgl_surat,suratsehat.butawarna,suratsehat.visus,suratsehat.keterangan "+                  
                     ...
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "where "+tgl+"and no_surat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and suratsehat.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and suratsehat.tgl_surat like '%"+TCari.getText().trim()+"%' "+ 
                     "order by suratsehat.no_surat ");
            }
    ...
    public void emptTeks() {
        ...
        NoSurat.setText("");
        visus.setText("");
        butawarna.setText(" Tidak Buta Warna");
        tanggalsurat.setDate(new Date());
         SimpleDateFormat formatter = new SimpleDateFormat("ddMMyyyy"); 
        String iniDiambil = formatter.format(new Date());
        
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_surat,3),signed)),0) from suratsehat where tgl_surat='"+Valid.SetTgl(tanggalsurat.getSelectedItem()+"")+"' ",
                "SKD/"+iniDiambil,3,NoSurat); 
//        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_surat,3),signed)),0) from suratsehat where tgl_surat='"+Valid.SetTgl(tanggalsurat.getSelectedItem()+"")+"' ",
//                "SKD/"+tanggalsurat.getSelectedItem().toString().substring(6,10)+tanggalsurat.getSelectedItem().toString().substring(3,5)+tanggalsurat.getSelectedItem().toString().substring(0,2),3,NoSurat); 
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            butawarna.setText(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString());
            visus.setText(tbObat.getValueAt(tbObat.getSelectedRow(),6).toString());   
            keterangansurat.setText(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString());
